...
def test_maintenance_still_delivers_notifications_when_scan_fails(
    ...
    monkeypatch.setattr(maintenance, "maintain_notification_tests", test_maintenance)
    monkeypatch.setattr(
    ...
    test_maintenance.assert_awaited_once_with(settings)
