...
class Operation(Base):
    ...
    requested_principal_snapshot: Mapped[dict | None] = mapped_column(JSON, nullable=True)
    confirmed_principal_snapshot: Mapped[dict | None] = mapped_column(JSON, nullable=True)
    authorization_mode: Mapped[str] = mapped_column(String(32), default="legacy")
...
class OperationTransition(Base):
    ...
    actor_principal_snapshot: Mapped[dict | None] = mapped_column(JSON, nullable=True)
