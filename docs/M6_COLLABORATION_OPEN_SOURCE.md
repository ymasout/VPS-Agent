...
当前状态：**M6.4a 已完成（`714da5a`，四条 CI 全绿，无生产金丝雀）；M6.4b 已完成独立审计、四条 CI 和两阶段生产只读金丝雀；M6.4c1 已完成（审计+CI+生产 shadow 金丝雀 2026-07-30），c2/c3 尚未实现；M6.4d 尚未开始。** 当前状态仍不代表已经具备团队写授权、全站 RBAC 或正式控制平面发行版。
