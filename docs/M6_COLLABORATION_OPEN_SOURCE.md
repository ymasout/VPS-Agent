...
当前状态：**M6.4a 已完成（`714da5a`，四条 CI 全绿）；M6.4b 已完成独立审计、四条 CI 和两阶段生产只读金丝雀；M6.4c（c1/c2/c3）已完成审计+CI+生产金丝雀（2026-07-31，含首次具名 M4 完整执行链）；M6.4d v0.6.1 已于 2026-08-01 正式公开发行（tag `v0.6.1`、32 资产、PVR 启用、GHCR 公开）。** 当前状态仍不代表已经具备全站 RBAC；SaaS/多租户继续冻结。
