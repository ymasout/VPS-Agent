...
当前状态：**M6.4a 已完成（`714da5a`，四条 CI 全绿）；M6.4b 已完成独立审计、四条 CI 和两阶段生产只读金丝雀；M6.4c（c1/c2/c3）已完成审计+CI+生产金丝雀（2026-07-31，含首次具名 M4 完整执行链）；M6.4d 正式发行链已建立并产出 v0.6.1（2026-08-01）与 v0.6.3（2026-08-04，镜像漏洞结构性清零）。** 当前状态仍不代表已经具备全站 RBAC；SaaS/多租户继续冻结。
