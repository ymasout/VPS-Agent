...
- M6 已完成：M6.1a/b、M6.2–M6.4d 已交付，v0.6.1 于 2026-08-01 正式发行并以精确 digest 通过生产升级金丝雀，2026-08-02 完成文档收口。后续批次 A 的 Agent last-known-good、已签名 release bundle 安全暂存和持续发行扫描已在本地实现、验证并通过独立审计和本地提交，待推送后 CI/单独金丝雀，不计作生产完成；批次 B 的完整灾备 RPO/RTO 仍仅有设计。Web SSH/高风险会话最后单独设计。
