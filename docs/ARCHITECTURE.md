...
- M6 已完成：M6.1a/b、M6.2–M6.4d 已交付，v0.6.1 于 2026-08-01 正式发行并以精确 digest 通过生产升级金丝雀，2026-08-02 完成文档收口。Agent last-known-good、完整灾备 RPO/RTO、生产自动验证/落地已签名 release bundle 和持续发行安全扫描作为后续加固（沿用 M6.1c/d 名称）；Web SSH/高风险会话最后单独设计。
