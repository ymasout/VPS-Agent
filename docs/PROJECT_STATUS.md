...
当前自动验证：API 55 项测试、Web 20 项测试、全部 Go 包测试、Ruff、ESLint、`go vet` 和 Web 生产构建通过。PostgreSQL DDL 已按 PostgreSQL 方言编译全部 17 张表，Alembic head 为 `0004_m3_service_discovery`；Caddyfile 本轮未修改，生产 Compose 配置继续可解析。
