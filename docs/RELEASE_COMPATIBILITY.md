...
| Release path | Database | Agent | Status before formal publish |
|---|---|---|---|
| Clean install `v0.6.1` | Empty PostgreSQL 16 → `0020_m6_named_approval` | `v0.6.1` amd64/arm64 | Required release gate |
| Current production baseline → `v0.6.1` | `0d75342`, revision `0020_m6_named_approval` | Existing `v0.4.2` | Required isolated upgrade gate |
