...
状态：**批次 A 已关闭；批次 B 已于 2026-08-16 收口（独立审计通过、备份/复制链路生产激活、月度解密抽检与季度演练 RPO/RTO 达标）。** M6 已于 2026-08-02 收口；
...
- （本条为 2026-08-14 本地实现时点记录，已由 2026-08-16 生产收口取代：真实异地副本、生产 recipient、生产副本与季度演练均已落地并通过，见 [M6_DISASTER_RECOVERY.md](./M6_DISASTER_RECOVERY.md)。）
...
上表 P2 RPO/RTO 阻断输入已关闭；其后批次 B 已于 2026-08-16 用异地加密副本、月度实际解密与计时隔离恢复证明达标，详见 10.1 与 [M6_DISASTER_RECOVERY.md](./M6_DISASTER_RECOVERY.md)。
