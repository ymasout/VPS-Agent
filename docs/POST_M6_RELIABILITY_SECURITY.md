...
状态：**批次 A 已实现、审计、通过 CI，并以 v0.6.3 于 2026-08-04 正式公开发行（候选 API/Web 四平台 Trivy 零 HIGH/CRITICAL）。批次 B 仍仅有设计。** M6 已于 2026-08-02 收口；
本文保留 M6.1c/M6.1d 名称只为延续既有追踪，不重新打开 M6。v0.6.3 生产升级与 Agent 事务式升级为独立授权金丝雀，尚未执行；
